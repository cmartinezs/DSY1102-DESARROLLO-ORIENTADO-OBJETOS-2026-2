...
El índice principal está en [`docs/extras/README.md`](./extras/README.md). Allí existe un roadmap sugerido para revisar recursos según el momento del curso.

Los extras cubren herramientas, terminal, Markdown, Git/GitHub, fundamentos de programación, lógica, matemáticas aplicadas, Java/POO y estrategias para resolver problemas.

> El material está adaptado a DSY1102 y no asume tecnologías backend avanzadas antes de que correspondan.
