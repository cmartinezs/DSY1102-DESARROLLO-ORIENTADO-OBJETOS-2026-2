...
Ejemplos simples para acompañar **Paradigma OO: fundamentos del lenguaje**.
...
2. [`Ejemplo02Condicionales.java`](Ejemplo02Condicionales.java)
3. [`Ejemplo03Switch.java`](Ejemplo03Switch.java)
4. [`Ejemplo04CicloFor.java`](Ejemplo04CicloFor.java)
